...
<section class="mt-8 px-4 pb-20">
    <div class="max-w-4xl mx-auto">
        <div class="bg-base-200 p-6 rounded-t-3xl border-b border-dashed border-gray-300 flex justify-between items-center">
            ...
            <c:if test="${review.type == 'REVIEW'}">
                <div class="text-right">
                    <div class="text-sm text-gray-500 mb-1">평점</div>
        ...
        <div class="bg-white p-8 rounded-b-3xl shadow-lg border border-gray-100">
            <div class="flex justify-between items-end mb-8 pb-4 border-b">
                <div>
                    ...
                    <div class="flex items-center gap-4 text-sm text-gray-400">
                        ...
                        <c:if test="${review.regDate != review.updateDate}">
                            <span class="text-xs italic">(수정됨: ${review.updateDate.substring(0, 16)})</span>
                        </c:if>
                    </div>
                </div>
            ...
            <div class="min-h-[300px] leading-relaxed text-lg text-gray-700 whitespace-pre-wrap">
                ${review.body}
            </div>
            ...
            <div class="flex justify-between mt-12 pt-6 border-t">
                ...
                <div class="flex gap-2">
                    <c:if test="${review.extra__canModify}">
                        <a class="btn btn-outline btn-warning" href="../review/modify?id=${review.id}">수정</a>
                    </c:if>
                    <c:if test="${review.extra__canDelete}">
                        <a class="btn btn-outline btn-error" 
                           href="../review/doDelete?id=${review.id}" 
