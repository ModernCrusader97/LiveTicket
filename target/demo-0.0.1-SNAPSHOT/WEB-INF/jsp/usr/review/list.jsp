...
<section class="mt-8 px-4 max-w-6xl mx-auto">
	...
	<div class="flex justify-between items-end mb-6">
		<div>
			<h2 class="text-3xl font-black text-gray-800">${param.type == 'REVIEW' ? '실관람 후기' : '공연 기대평'}</h2>
						...
						<c:if test="${review.type == 'REVIEW'}">
							<div class="rating rating-xs">
								<c:forEach begin="1" end="5" var="i">
									<input type="radio" name="rating-${review.id}" class="mask mask-star-2 bg-orange-400"
